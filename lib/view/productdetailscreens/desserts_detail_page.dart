...
class DessertsDetailPage extends StatefulWidget {
  final String name;
  final String image;
  final int price;
  final String description;
  final String heroTag;
  const DessertsDetailPage(
      {super.key,
      required this.name,
      required this.image,
  ...
  @override
  State<DessertsDetailPage> createState() => _ProductDetailPageState();
}

class _ProductDetailPageState extends State<DessertsDetailPage> {
  int groupValue1 = 1;
  int groupValue2 = 4;
