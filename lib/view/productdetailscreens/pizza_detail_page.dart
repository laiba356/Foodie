...
class PizzaDetailPage extends StatefulWidget {
  ...
  @override
  State<PizzaDetailPage> createState() => _ProductDetailPageState();
}

class _ProductDetailPageState extends State<PizzaDetailPage> {
  int groupValue1 = 1;
  int groupValue2 = 4;
                        ...
                        children: [
                          ...
                          RadioListTile(
                            ...
                            onChanged: (value) {
                              setState(() {
                                groupValue1 = value!;
                                addToCartPrice = widget.price - 500;
                              });
                            },
                          ),
                          RadioListTile(
                            ...
                            onChanged: (value) {
                              setState(() {
                                groupValue1 = value!;
                                addToCartPrice = widget.price - 1000;
                              });
                            },
                          ),
